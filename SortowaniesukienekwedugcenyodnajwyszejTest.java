...
import java.net.URL;
public class SortowaniesukienekwedugcenyodnajwyszejTest {
  ...
  @Test
  public void sortowaniesukienekwedugcenyodnajwyszej() {
    driver.get("http://automationpractice.com/index.php");
    driver.manage().window().setSize(new Dimension(997, 734));
